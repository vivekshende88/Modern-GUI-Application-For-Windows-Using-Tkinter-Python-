...
def weather():
    ...
    def getWeather():
        ...
        #weather
        api="https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=f0506d1da1d40ef4d4b5c242b4e98373"
    ...
    label3=Label(app1,text="DESCRIPTION",font=("Helvetica",13,'bold'),fg="white",bg="#1ab5ef")
    label3.place(x=430,y=400)

    label4=Label(app1,text="PRESSURE",font=("Helvetica",14,'bold'),fg="white",bg="#1ab5ef")
...
def close_apps():
    wb.register('chrome', None)
    wb.open("https://www.youtube.com/watch?v=2lo53YO7ZeM&ab_channel=DYP%2CTalsande")
